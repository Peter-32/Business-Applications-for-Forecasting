...
first_order_diff = page_visits.diff(1)
first_order_diff = first_order_diff.iloc[1:]
plot_page_visits_and_first_order_differencing(page_visits, second_order_diff)
plot_ACF_page_visits_and_first_order_differencing(page_visits, second_order_diff)

adf_result = stattools.adfuller(pd.Series(page_visits['visits']), autolag='AIC')
print('p-val of the ADF test in air miles flown:', adf_result[1])
adf_result = stattools.adfuller(pd.Series(second_order_diff['visits']), autolag='AIC')
print('p-val of the ADF test in air miles flown:', adf_result[1])
